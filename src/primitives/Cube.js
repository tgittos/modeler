MODELER.Cube = function(params, my) {
  ...
  var initialize = function(){
    ...
    my.vertices = [
      -1.0, -1.0, -5.0, // front bottom left  [0]
      -1.0, 1.0, -5.0, // front top left      [1]
      1.0, 1.0, -5.0, // front top right      [2]
      1.0, -1.0, -5.0, // front bottom right  [3]
      -1.0, -1.0, -4.0, // back bottom left    [4]
      -1.0, 1.0, -4.0, // back top left        [5]
      1.0, 1.0, -4.0, // back top right        [6]
      1.0, -1.0, -4.0 // back bottom right     [7]
    ];
    my.indices = [
